...
|---|---|---|---|---|
| GTNHLib | https://github.com/GTNewHorizons/GTNHLib at `9644810c` (release `0.9.59`, tag `gtnhlib-base/9644810c00`) | `src/main/java`: the 57 kept files that upstream has, 28 of them verbatim. `src/test/java`: `VertexFormatTest` | LGPL-3.0 ([`LICENSE-LGPL-3.0.txt`](LICENSE-LGPL-3.0.txt)), plus the file-level notices below | yes, except the test |
